...
public class Controlador {
  ...
  void iniciarHistoria(ActionEvent event) {
    ...
    // dicionario de capitulos que é integrado com as escolhas e personagens quando
    // for lido
  ...
  public void mostrarEscolhas(ArrayList<Escolha> escolhas) {
    ...
    { // Esses botões extends a classe botao e invés de no botao ter um texto ele
      ...
      // Aqui eu determino o que acontece ao clicar, iai o EVENTHANDLER é responsável
      // por lidar com o evento
      {
